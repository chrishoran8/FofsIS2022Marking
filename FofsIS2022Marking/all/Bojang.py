...
##Student Name: Dodou Bojang
##Course Number:SIMR21-001
##Student Number:30109621 
...
print("This is the product of fltThree and fltFour: ", fltThree * fltFour)
...
############### ############### ############### ############### ############### ############### ############### ############### ############### -2
#why was a for loop used below? I have removed it and it works fine. However, you lose 2 points for adding in a for loop
...
listOfStrings=["Hello", "Hi", "Salut", "Good_Day", "Bon_Dia", "Howdy"]
...
print("These are the greeting words: ", listOfStrings)
...
############### ############### ############### ############### ############### ############### ############### ############### ############### -12
#no attempt made at below, lose 12 points

#original below
#for word in listOfStrings:
#    print(min[ListOfStrings])
...
caseChanger=input("Enter your word: " )
#It will return the word with all letters in the same case except 'a' which it will convert to 'A'
############### ############### ############### ############### ############### ############### ############### ############### ############### -10
#your syntax let you down here. You correctly identified that you needed a for loop and if statement, but you haven't implemented it correctly. You lose 10 marks

for i in caseChanger:
    if i in caseChanger=="a":
        "a".upper
print("this is A capitalised",caseChanger)
...
############### ############### ############### ############### ############### ############### ############### ############### ############### -2
#no need for a for loop here, however it is sorted ok. Lose 2 marks
...
############### ############### ############### ############### ############### ############### ############### ############### ############### 
#no need for cars_tup here


topSpeed= (120,100,125,126,78,40,105,93)
cars_tup= ("Focus","Up","Golf","Robin","Fiesta","Astra","Tiguan","Leaf") 
...
############### ############### ############### ############### ############### ############### ############### ############### ############### -4
#Your method has considerable risk of mistake. You were given a list and a tuple which you could have used to create your dictionary. Lose 4 points


carSpeeds={"Astra":120,"Fiesta":100,"Focus":125,"Leaf":126,"Golf":78,"Robin":40,"Tiguan":105,"Up":93}
